...
# Veri setini oku
df = spark.read.csv("file:///home/seed/Desktop/dagitik/cleaned_twitter_data.csv", header=True, inferSchema=True)
...
print(f"\n[TIME] 500k içinToplam süre: {total_end_time - total_start_time:.2f} saniye")
